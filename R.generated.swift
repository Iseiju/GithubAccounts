...
struct R: Rswift.Validatable {
  ...
  struct image {
    /// Image `ic-github`.
    static let icGithub = Rswift.ImageResource(bundle: R.hostingBundle, name: "ic-github")
    /// Image `ic-placeholder`.
    static let icPlaceholder = Rswift.ImageResource(bundle: R.hostingBundle, name: "ic-placeholder")

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "ic-github", bundle: ..., traitCollection: ...)`
    static func icGithub(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.icGithub, compatibleWith: traitCollection)
    }
    #endif
